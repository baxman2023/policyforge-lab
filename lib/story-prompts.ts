...
- Background prompts must be complete full-frame 16:9 wordless environmental images, not YouTube thumbnails, posters, ads, infographics, title cards, lower thirds, checklists, signs, labels, logos, UI screens, documents, paperwork, whiteboards, phone screens, computer screens, tablet screens, license plates, presentation boards, poster boards, blank signs, blank cards, blank screens, empty frames, or large blank white panels.
- Background prompts must ask for actual visual environments only: home exterior, driveway, car interior with no visible dashboard text, family kitchen without papers, living room, insurance office without screens or signs, Houston neighborhood street with no readable signs, stormy sky, garage, keys, house, vehicle, or small business exterior with no signage.
- Background prompts must not include any readable words, numbers, letters, phone numbers, addresses, document text, license plate text, brand names, "HeyGen", "hook", overlay text, captions, or quoted phrases.
